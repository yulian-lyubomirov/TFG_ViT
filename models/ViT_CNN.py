...
from functions.helpers import kmeans_clustering,topk_operation
# helpers
...
class CNNPatchEmbedding(nn.Module):
    def __init__(self, image_height, image_width, patch_size, in_channels, dim):
        ...
        self.conv3 = nn.Conv2d(32, dim, kernel_size=(patch_size, patch_size), stride=(patch_size, patch_size))
...
class ViT_CNN(nn.Module):
    ...
    def forward(self, img):
        ...
        x = self.to_patch_embedding_conv2d(img) 
        b, n, _ = x.shape
...
#                 Attention(dim, num_clusters, tau, lr),
#                 FeedForward(dim, mlp_dim, dropout=dropout)
#             ])
